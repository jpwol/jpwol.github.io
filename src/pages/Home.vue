    ...
    >
      <header class="space-y-4 mt-20">
        ...
        <a
          ...
          class="text-xl text-sky-300 hover:text-white transform transition-all duration-300 hover:text-2xl"
          >Wilkes University</a
        >
      </header>
      <div class="flex space-x-4 lg:mb-20 md:pt-10 sm-pt-10">
